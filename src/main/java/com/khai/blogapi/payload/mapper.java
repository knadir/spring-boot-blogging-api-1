...
public class mapper {
	...
	public static List<GenderResponse> gendersToGenderResponse(List<Gender> genders) {
	...
	public static QualificationResponse qualificationToQualificationResponse(Qualification qualification) {
	...
	public static List<QualificationResponse> qualificationsToQualificationResponse(
		...
		for (Qualification qualification : qualifications) {
			qualificationResponse.add(qualificationToQualificationResponse(qualification));
		}
		return qualificationResponse;
	}
	...
	public static List<DepartmentResponse> departmentsToDepartmentResponse(List<Department> departments) {
	...
	public static EmployerResponse employerToEmployerResponse(Employer employer) {
		...
		if (employer != null && employer.getQualification() != null) {
			employerResponse.setQualificationName(employer.getQualification().getName());
		}
		if (employer != null && employer.getDepartment() != null) {
			employerResponse.setDepartmentId(employer.getDepartment().getId());
		}
		if (employer != null && employer.getDepartment() != null) {
			employerResponse.setDepartmentName(employer.getDepartment().getName());
		}
